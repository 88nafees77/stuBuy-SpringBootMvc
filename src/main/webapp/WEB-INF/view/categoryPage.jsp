...
<body>
	...
	<div class="container-fluid"
		style="background-color: window; padding: 0px; height: auto">
		<div class="row" style="background-color: bisque;">
			...
			<div class=" col-lg-2 col-md-3 col-sm-3 col-4"
				...
				<li class="dropdown" style="padding-top: 6px;">
					...
					<!-- 						type="button" data-toggle="dropdown"> --> <!-- 						Electronics <span class="caret"></span> -->
					<!-- 					</button> --> <!-- 					<ul class="dropdown-menu ml-auto"> -->
					<!-- 						<li style="padding: 10px;"><a --> <!-- 							href="fc/?page=homepage_1&type=view">Mobiles</a></li> -->
		...
		<div class="container-fluid" style="padding: 0px; height: auto">
			...
			<div class="row" style="background-color: #efefef">
				<c:forEach var="sports" items="${sports}" varStatus="status">
					<div class="col-sm-3 col-lg-3 col-md-3 col-3">
						<div class="card" style="width: 100%;">
							<a href="/img/details/${sports.productName}"> <img
								class="card-img-top" src="/img/display/${sports.productName}"
			...
			<%-- 2nd row --%>
			<div class="row" style="background-color: #efefef">
				<c:forEach var="jewellery" items="${jewellery}" varStatus="status">
					<div class="col-sm-3 col-lg-3 col-md-3 col-3">
						<div class="card" style="width: 100%;">
							<a href="/img/details/${jewellery.productName}"> <img
								class="card-img-top" src="/img/display/${jewellery.productName}"
								alt="Card image" style="width: 100%; height: 300px;">
							</a>
							<div class="card-body btn btn-primary btn btn-sm"
			...
			<div class="row" style="background-color: #efefef">
				<c:forEach var="books" items="${books}" varStatus="status">
					<div class="col-sm-3 col-lg-3 col-md-3 col-3">
						<div class="card" style="width: 100%;">
							<a href="/img/details/${books.productName}"> <img
								class="card-img-top" src="/img/display/${books.productName}"
								alt="Card image" style="width: 100%; height: 300px;">
							</a>
							<div class="card-body btn btn-primary btn btn-sm"
						...
						<div class="row">
							<div class="col-lg-3 col-md-3 col-sm-3 col-12 footer-info">
								...
								<p>Its an e- Commerse Website created for the students where
									they can buy new as well as used products which are being sold
									by other Students</p>
							</div>
